					...
					<tbody>
						...
						<?php foreach ($agama as $key): ?>
							<tr>
								...
								<td><?= $key['agama'] ?></td>
								<td>
									<a href="<?= base_url("DataMaster/updateAgama/$key[id]"); ?>" class="badge badge-success updateAgamaModalButton" data-toggle="modal" data-target="#newAgamaModal" data-id="<?=$key['id']?>">Edit</a>
									<a href="<?= base_url("DataMaster/deleteAgama/$key[id]"); ?>" class="badge badge-danger" onclick="return confirm('Are you sure?');">Delete</a>
								</td>
							</tr>
							<?php $no++; ?>
						<?php endforeach ?>
