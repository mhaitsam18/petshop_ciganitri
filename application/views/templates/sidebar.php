<!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar" style="background-color: #F6E6E6 !important;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>">
                ...
                <div class="sidebar-brand-text mx-3">
                    <img src="<?=base_url('assets/img/logo/petshop_sidebar.png') ?>" style="width: 100%;">
                    <!-- <?= $dashboard['title'] ?> -->
                </div>
                     <!-- style="color: #F6A5B8;" -->
            </a>
